    ...
    return (
        <div className='p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-4'>
            ...
            <div className="flex flex-col gap-4 text-gray-500">
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto, hic eligendi. Voluptas ullam dolorem temporibus accusantium, rem quos libero eos culpa nihil. 
                </p>
                <div className="flex items-center gap-2">
